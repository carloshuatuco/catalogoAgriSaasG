      ...
      <header className="bg-white border-b border-gray-100 sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <span className="text-[#156d5e] text-3xl">🌲</span>
            <span className="font-extrabold text-xl tracking-tight text-gray-900">MAGISTRAL</span>
          </div>
      ...
      <footer className="bg-gray-900 text-gray-400 py-12 text-center">
         <div className="container mx-auto px-4">
            <div className="flex items-center justify-center gap-2 mb-6">
              ...
              <span className="font-extrabold text-lg tracking-widest text-white uppercase">MAGISTRAL SAAS</span>
            </div>
